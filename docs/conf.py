...
project = u'PySAT'
copyright = u'2018-2022, Alexey Ignatiev, Joao Marques-Silva, Antonio Morgado'
...
latex_documents = [
    (master_doc, 'PySAT.tex', u'PySAT Documentation',
     u'Alexey Ignatiev, Joao Marques-Silva, Antonio Morgado', 'manual'),
]
